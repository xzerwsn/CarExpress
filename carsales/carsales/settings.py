...
SECRET_KEY = 'django-insecure-3@h4vaf1d(wghiqxql%5)m^r_!qnbb#rv2(x)r)^g1o1l_c*8h'
...
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'xzerwsnwork@mail.ru'
EMAIL_HOST_PASSWORD = '9085521215Gxdq'
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
ADMIN_EMAIL = 'xzerwsnwork@mail.ru'  # Куда отправлять письма
